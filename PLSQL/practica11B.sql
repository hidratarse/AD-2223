...
/*6.2 MAL*/
SELECT LIN.CANTIDAD, LIN.NUMEROLINEA, P.DESCRIPCION  FROM TABLA_VENTAS TV, TABLE(TV.LINEAS) LIN, TABLA_PRODUCTOS P WHERE TV.IDVENTAS=2 AND LIN.IDPRODUCTO=DEREF(P.IDPRODUCTO); 
...
/*6.6 MAL*/
UPDATE TABLA_CLIENTES 
SET  DIREC.CALLE='CALLE ESTOPA 34'
WHERE DIREC=(SELECT DIREC FROM TABLA_CLIENTES WHERE IDCLIENTE=2);
