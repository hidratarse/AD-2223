...
/*6.12*/
CREATE OR REPLACE PROCEDURE VISUALIZADOR (IDVENTAS NUMBER)
AS
    V_IDVENTA NUMBER; 
...
DBMS_OUTPUT.PUT_LINE('NUMERO DE VENTA: ' || V_IDVENTA || '  FECHA DE VENTA: ' || V_DATE || '\n')
DBMS_OUTPUT.PUT_LINE('CLIENTE: ' || V_NOMBRE ||'\n');
DBMS_OUTPUT.PUT_LINE('DIRECCION: ' || V_DIREC ||'\n');
DBMS_OUTPUT.PUT_LINE( LINEAS.IDLINEA || V_DIREC ||'\n')